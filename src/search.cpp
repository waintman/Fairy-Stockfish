...
#else
        &&  ss->staticEval >= beta - 20 * depth - improvement / 15 + 204 + 200 * (!pos.double_step_region(pos.side_to_move()) && (pos.piece_types() & PAWN))
#endif
        && !excludedMove
          ...
          && bestValue > VALUE_TB_LOSS_IN_MAX_PLY)
      {
          ...
          else
          {
              ...
              if (   !ss->inCheck
                  ...
                  && ss->staticEval + (172 + 145 * lmrDepth) * (1 + pos.check_counting()) <= alpha)
#endif
                  continue;
